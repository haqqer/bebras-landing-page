      ...
      <nav className="absolute top-0 left-0 right-0 mx-auto py-4 px-4 md:px-16 w-full">
        <div className="container items-center flex justify-between">
          ...
          <div role="menubar" className={`
            flex flex-col gap-2 md:gap-3 lg:gap-4 absolute right-0 left-0 top-16  shadow-md text-center p-4 sm:text-base text-lg items-center
            lg:flex lg:flex-row lg:static lg:shadow-none lg:justify-between sm:bg-white lg:bg-transparent
            ${menuBar ? "bg-white" : "hidden"}
          `}>
            <a href="https://bebras.or.id/v3/#" target="_blank" className="py-1 px-3 focus:outline-none focus-visible:ring-4 ring-neutral-900 rounded-sm ring-offset-4 ring-offset-amber-400 text-neutral-900 hover:text-neutral-500 transition-colors">Tentang Bebras</a>
            <a href=" https://pandai.bebras.or.id/" target="_blank" className="py-1 px-3 focus:outline-none focus-visible:ring-4 ring-neutral-900 rounded-sm ring-offset-4 ring-offset-amber-400 text-neutral-900 hover:text-neutral-500 transition-colors">Gerakan Pandai</a>
            <a href="https://bebras.or.id/v3/kegiatan-bebras" target="_blank" className="py-1 px-3 focus:outline-none focus-visible:ring-4 ring-neutral-900 rounded-sm ring-offset-4 ring-offset-amber-400 text-neutral-900 hover:text-neutral-500 transition-colors">Kegiatan</a>
            <a href="https://bebras.or.id/v3/bebras-biro/" target="_blank" className="py-1 px-3 focus:outline-none focus-visible:ring-4 ring-neutral-900 rounded-sm ring-offset-4 ring-offset-amber-400 text-neutral-900 hover:text-neutral-500 transition-colors">Kontak</a>
          </div>
      ...
      <footer className="mx-auto py-3 px-4 md:px-16 w-full">
        <div className="container items-center flex justify-between flex-col sm:flex-col lg:flex-row gap-2">
          ...
          `}>
            ...
            <a href="https://docs.google.com/document/d/1aj1cWrPak3f9On8Bj3KJO68p4MDtZPpWZCBquJZ9Nx0/edit#heading=h.emtp3oalxuat" target="_blank" className="font-light py-1 px-3 focus:outline-none focus-visible:ring-4 ring-neutral-900 rounded-sm ring-offset-4 ring-offset-amber-400 text-neutral-900 hover:text-neutral-500 transition-colors">Privacy</a>
            <a href="https://bebras.or.id/v3/bebras-biro" target="_blank" className="font-light py-1 px-3 focus:outline-none focus-visible:ring-4 ring-neutral-900 rounded-sm ring-offset-4 ring-offset-amber-400 text-neutral-900 hover:text-neutral-500 transition-colors">Kontak</a>
          </div>
          ...
          `}>
            ...
            <a href="https://www.facebook.com/groups/bebrasindonesia/" target="_blank" className="">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-6 h-6" viewBox="0 0 16 16">
                <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951"/>
              </svg>              
            </a>
            <a href="https://twitter.com/BebrasIndonesia" target="_blank" className="">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-6 h-6" viewBox="0 0 16 16">
                <path d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334q.002-.211-.006-.422A6.7 6.7 0 0 0 16 3.542a6.7 6.7 0 0 1-1.889.518 3.3 3.3 0 0 0 1.447-1.817 6.5 6.5 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.32 9.32 0 0 1-6.767-3.429 3.29 3.29 0 0 0 1.018 4.382A3.3 3.3 0 0 1 .64 6.575v.045a3.29 3.29 0 0 0 2.632 3.218 3.2 3.2 0 0 1-.865.115 3 3 0 0 1-.614-.057 3.28 3.28 0 0 0 3.067 2.277A6.6 6.6 0 0 1 .78 13.58a6 6 0 0 1-.78-.045A9.34 9.34 0 0 0 5.026 15"/>
              </svg>              
            </a>
            <a href="https://www.instagram.com/bebras.indonesia/" target="_blank" className="">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-6 h-6" viewBox="0 0 16 16">
